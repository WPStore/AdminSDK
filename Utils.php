...
class Utils {
	 ...
	 *
	 * @since  0.0.10
	 * @param  string $type [class|function|plugin_file|plugin_path]
	 * @param  string|array $search
	 * @return string Status of the plugin [active|inactive|missing]
	 */
	public static function detect_plugin( $type, $search ) {
...
//			$result = forward_static_call( array( 'Utils', 'detect_' . $type ), $search );
